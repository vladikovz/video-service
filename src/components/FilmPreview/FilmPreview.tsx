...
export class FilmPreview extends Component<any> {
    render() {
        return (
            <>
                <section className={style.mainWrapper}>
                    ...
                    <div className={style.mainInformation}>
                        ...
                        <div className={style.movieDescription}>
                            ...
                            justo congue massa metus ipsum auctor, sit tellus pharetra, sapien
                            at. Et bibendum congue: vivamus molestie amet ipsum et, sapien
                            morbi, metus magna, maecenas fusce quam, eget. Arcu sagittis
                            magna, quam elementum cursus proin porta urna nec proin. Ipsum
                            maecenas lectus tellus
                        </div>
                    ...
                    <div className={style.moviesSettings}>
                        <Button className={style.settingsButton} variant="contained" color="primary">
                            Sound
                        </Button>
                        <Button className={style.settingsButton} variant="contained" color="primary">
                            FullScreen
